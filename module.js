    ...
    angular
        ...
        .config(function($routeProvider){
            ...
            .when("/about", {
                ...
                <p class="element-animation" id="paraSize">I am a Front-end Developer student at Grand Circus, located in Detroit, Michigan.  
                ...
                <img src="images/me.jpg" alt="" class="portrait">
                </div>
                `
            })
            .when("/projects", {
